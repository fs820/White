...
#define CYLINDER_TEX "data\\TEXTURE\\End000.jpg"
#define CYLINDER_MAX (64)
#define CYLINDER_RADIUS (4500.0f)
#define CYLINDER_HEIGHT (1000.0f)
#define CYLINDER_WIDTH_DEF (1280.0f)
#define CYLINDER_HEIGHT_DEF (1048.8f)
